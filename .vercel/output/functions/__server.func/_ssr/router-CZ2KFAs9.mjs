...
const appCss = "/assets/styles-C_ebikNn.css";
...
const $$splitComponentImporter$3 = () => import("./admin-CENkDszH.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-DXi3Sy5K.mjs");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tap your NFC card to unlock a private memory portal: photos, music, and video — secured with a personal PIN."
    }, {
      property: "og:title",
      content: "Signatureday — NFC Memory Portal"
    }, {
      property: "og:description",
      content: "A premium glass-morphism memory portal for NFC cards. Tap, verify, remember."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./card._id-CJq5Yihb.mjs");
const Route$1 = createFileRoute("/card/$id")({
  head: ({
    params
  }) => ({
    meta: [{
      ...
      name: "description",
      content: "Unlock this Signatureday NFC memory portal."
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const $$splitComponentImporter = () => import("./card._id.reset-BdSInDuQ.mjs");
const Route2 = createFileRoute("/card/$id/reset")({
  head: ({
    params
  }) => ({
    meta: [{
...
const CardIdRoute = Route$1.update({
  id: "/card/$id",
  path: "/card/$id",
  getParentRoute: () => Route$4
});
const CardIdResetRoute = Route2.update({
  id: "/reset",
  path: "/reset",
  getParentRoute: () => CardIdRoute
});
const CardIdRouteChildren = {
  CardIdResetRoute
};
const CardIdRouteWithChildren = CardIdRoute._addFileChildren(CardIdRouteChildren);
